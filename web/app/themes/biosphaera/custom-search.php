...
<?php if (empty($query->posts)): ?>
  ...
  <form role="search" method="get" class="search-form" action="<?php echo apply_filters( 'wpml_object_id', get_page_by_title('Search Results')->ID, 'page', false, ICL_LANGUAGE_CODE); ?>">
      <?php echo '<label>
